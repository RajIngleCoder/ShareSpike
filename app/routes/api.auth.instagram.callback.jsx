...
// Import supabase only within the loader function
...
// Remix loader function that handles the callback
export async function loader({ request }) {
  ...
  try {
    ...
    // Import supabase dynamically inside this function
    const { supabase } = await import("../supabase.server");
    
    const upsertData = {
      shop_id: shop, // Use the shop domain directly from state
    ...
    console.log(`[IG Callback-Remix] Successfully upserted Instagram connection for shop: ${shop}`);
...
// This is needed for Remix routes
